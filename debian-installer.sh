...
sudo nala install -y acpi acpid alacritty alsa-utils avahi-daemon build-essential curl dialog dunst dbus-x11 dosfstools feh firefox-esr gvfs-backends libnotify-bin lightdm lxappearance lxinput lxrandr mtools neofetch network-manager network-manager-gnome numix-icon-theme openbox obconf obmenu pavucontrol pipewire volumeicon-alsa menu mousepad qt5-style-plugins qt5-style-kvantum rofi thunar tint2 wmctrl vlc
